...
skills/master-blog/
  ...
  references/               writing layers · publishing & measurement · media brief ·
                            checklist ·
  ...
  scripts/olcum.py          measurement ledger: 14/28/90-day checkpoints + control group
  scripts/skill-denetim.py  the skill's own internal consistency audit
